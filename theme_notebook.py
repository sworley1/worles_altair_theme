...
@app.cell
def _():
    data = pl.from_pandas( vega_datasets.data.cars() )
    return (data,)
...
@app.cell
def _():
    from worles_altair_theme import worles, darkmode_worles#, catColors
    alt.theme.enable('darkmode_worles')
    a=2
    return (a,)
...
def _(a, data):
    ...
    alt.Chart(data).mark_bar().encode(
        ...
        alt.Y("count()")
    ).properties(title="Hist of Displacement")
    return
...
def _(a, data):
    ...
    alt.Chart(data, 
        ...
        alt.X("Acceleration"),
        alt.Y("Origin"),
        alt.Color("Origin:N")#.scale(range=catColors)
